...
cc.Class({
    ...
    init: function (rank, data) {
        ...
        if (rank == 0) {
            this.rankLabel.node.color = new cc.Color(208, 117, 19, 255);
            this.rankLabel.node.setScale(2);
        } else if (rank == 1) {
            this.rankLabel.node.color = new cc.Color(238,189, 54, 255);
            this.rankLabel.node.setScale(1.6);
        } else if (rank == 2) {
            this.rankLabel.node.color = new cc.Color(255, 219, 8, 255);
