/* 
	 * @description: 子域GameRankingLsit脚本
	 * @author: Amumu
...
cc.Class({
        ...
        if (CC_WECHATGAME) {
            ...
            window.wx.onMessage(data => {
                ...
                if (data.messageType == 0) {
                    ...
                    this.fetchWorldData(data.MAIN_MENU_NUM);
                }
            });
        } else {
    ...
    removeChild() {
        //移除好友排行显示的自身排行
        var userItem = this.node.getChildByName('userItem');
        this.node.removeChild(userItem);
                        ...
                        success: res => {
                            ...
                            for (let i = 0; i < data.length; i++) {
                                ...
                                if (data[i].avatarUrl == userData.avatarUrl) {
                                    ...
                                    userItem.y = -325;
                                    this.node.addChild(userItem, 1,"userItem");
                                }
                            }
                        },
                        fail: res => {
